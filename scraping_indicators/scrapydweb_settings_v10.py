...
# SCRAPY_PROJECTS_DIR = 'W:\RESEARCH\Personal Folders\Jeremy\Lead Indicators'
SCRAPY_PROJECTS_DIR = os.path.dirname(os.getcwd())
...
EMAIL_PASSWORD = 'IMLpassword'

# e.g. 'username@gmail.com'
EMAIL_SENDER = 'jtang.iml@gmail.com'
# e.g. ['username@gmail.com', ]
EMAIL_RECIPIENTS = ['jeremy.tang@iml.com.au']
